...
{
    MinerIslands = {
        {x = -570.90, y = 45.80, z = -242.08, nodeName = "採掘場"},
        {x = -512.28, y = 35.19, z = -256.92, nodeName = "採掘場"},
        {x = -448.87, y = 32.54, z = -256.16, nodeName = "採掘場"},
        {x = -403.11, y = 11.01, z = -300.24, nodeName = "岩場"}, -- Fly Issue #1
        {x = -363.65, y = -1.19, z = -353.93, nodeName = "岩場"}, -- Fly Issue #2
        {x = -337.34, y = -0.38, z = -418.02, nodeName = "採掘場"},
        {x = -290.76, y = 0.72, z = -430.48, nodeName = "採掘場"},
        {x = -240.05, y = -1.41, z = -483.75, nodeName = "採掘場"},
        {x = -166.13, y = -0.08, z = -548.23, nodeName = "採掘場"},
        {x = -128.41, y = -17.00, z = -624.14, nodeName = "採掘場"},
        {x = -66.68, y = -14.72, z = -638.76, nodeName = "岩場"},
        {x = 10.22, y = -17.85, z = -613.05, nodeName = "岩場"},
        {x = 25.99, y = -15.64, z = -613.42, nodeName = "採掘場"},
        {x = 68.06, y = -30.67, z = -582.67, nodeName = "採掘場"},
        {x = 130.55, y = -47.39, z = -523.51, nodeName = "採掘場"}, -- End of Island #1
        {x = 215.01, y = 303.25, z = -730.10, nodeName = "岩場"}, -- Waypoint #1 on 2nd Island (Issue)
        {x = 279.23, y = 295.35, z = -656.26, nodeName = "採掘場"},
        {x = 331.00, y = 293.96, z = -707.63, nodeName = "岩場"}, -- End of Island #2
        {x = 458.50, y = 203.43, z = -646.38, nodeName = "岩場"},
        {x = 488.12, y = 204.48, z = -633.06, nodeName = "採掘場"},
        {x = 558.27, y = 198.54, z = -562.51, nodeName = "採掘場"},
        {x = 540.63, y = 195.18, z = -526.46, nodeName = "採掘場"}, -- End of Island #3
        {x = 632.28, y = 253.53, z = -423.41, nodeName = "岩場"}, -- Sole Node on Island #4
        {x = 714.05, y = 225.84, z = -309.27, nodeName = "岩場"},
        {x = 678.74, y = 225.05, z = -268.64, nodeName = "岩場"},
        {x = 601.80, y = 226.65, z = -229.10, nodeName = "岩場"},
        {x = 651.10, y = 228.77, z = -164.80, nodeName = "採掘場"},
        {x = 655.21, y = 227.67, z = -115.23, nodeName = "採掘場"},
        {x = 648.83, y = 226.19, z = -74.00, nodeName = "採掘場"}, -- End of Island #5
        {x = 472.23, y = -20.99, z = 207.56, nodeName = "岩場"},
        {x = 541.18, y = -8.41, z = 278.78, nodeName = "岩場"},
        {x = 616.091, y = -31.53, z = 315.97, nodeName = "採掘場"},
        {x = 579.87, y = -26.10, z = 349.43, nodeName = "岩場"},
        {x = 563.04, y = -25.15, z = 360.33, nodeName = "採掘場"},
        {x = 560.68, y = -18.44, z = 411.57, nodeName = "採掘場"},
        {x = 508.90, y = -29.67, z = 458.51, nodeName = "採掘場"},
        {x = 405.96, y = 1.82, z = 454.30, nodeName = "採掘場"},
        {x = 260.22, y = 91.10, z = 530.69, nodeName = "岩場"},
        {x = 192.97, y = 95.66, z = 606.13, nodeName = "岩場"},
        {x = 90.06, y = 94.07, z = 605.29, nodeName = "採掘場"},
        {x = 39.54, y = 106.38, z = 627.32, nodeName = "採掘場"},
        {x = -46.11, y = 116.03, z = 673.04, nodeName = "採掘場"},
        {x = -101.43, y = 119.30, z = 631.55, nodeName = "採掘場"}, -- End of Island #6?
        {x = -328.20, y = 329.41, z = 562.93, nodeName = "岩場"},
        {x = -446.48, y = 327.07, z = 542.64, nodeName = "岩場"},
    ...
    BotanistIslands =
    {
        {x = -202, y = -2, z = -310, nodeName = "良木"},
        {x = -262, y = -2, z = -346, nodeName = "良木"},
        {x = -323, y = -5, z = -322, nodeName = "良木"},
        {x = -372, y = 16, z = -290, nodeName = "草刈場"},
        {x = -421, y = 23, z = -201, nodeName = "草刈場"},
        {x = -471, y = 28, z = -193, nodeName = "良木"},
        {x = -549, y = 29, z = -211, nodeName = "良木"},
        {x = -627, y = 285, z = -141, nodeName = "草刈場"},
        {x = -715, y = 271, z = -49, nodeName = "良木"},

        {x = -45, y = -48, z = -501, nodeName = "草刈場"},
        {x = -63, y = -48, z = -535, nodeName = "草刈場"},
        {x = -137, y = -7, z = -481, nodeName = "草刈場"},
        {x = -191, y = -2, z = -422, nodeName = "良木"},
        {x = -149, y = -5, z = -389, nodeName = "良木"},
        {x = 114, y = -49, z = -515, nodeName = "良木"},
        {x = 46, y = -47, z = -500, nodeName = "良木"},

        {x = 101, y = -48, z = -535, nodeName = "草刈場"},
        {x = 58, y = -37, z = -577, nodeName = "草刈場"},
        {x = -6, y = -20, z = -641, nodeName = "草刈場"},
        {x = -65, y = -19, z = -610, nodeName = "良木"},
        {x = -125, y = -19, z = -621, nodeName = "良木"},
        {x = -169, y = -7, z = -550, nodeName = "草刈場"},

        {x = 454, y = 207, z = -615, nodeName = "草刈場"},
        {x = 573, y = 191, z = -513, nodeName = "良木"},
        {x = 584, y = 191, z = -557, nodeName = "草刈場"},
        {x = 540, y = 199, z = -617, nodeName = "草刈場"},
        {x = 482, y = 192, z = -674, nodeName = "草刈場"},

        {x = 433, y = -15, z = 274, nodeName = "良木"},
        {x = 467, y = -13, z = 268, nodeName = "草刈場"},
        {x = 440, y = -25, z = 208, nodeName = "良木"},
        {x = 553, y = -32, z = 419, nodeName = "草刈場"},
        {x = 564, y = -31, z = 339, nodeName = "草刈場"},
...
function Ready()
    ...
    elseif ShouldExtractMateria and CanExtractMateria(100) and GetInventoryFreeSlotCount() > 1 then
        ...
        LogInfo("[UmbralGathering] State Change: ExtractMateria")
...
function ExtractMateria()
    ...
    if CanExtractMateria(100) and GetInventoryFreeSlotCount() > 1 then
        ...
        LogInfo("[UmbralGathering] Extracting materia...")
...
function EnterDiadem()
    ...
    elseif HasTarget() and GetTargetName() == "オールヴァエル" then
        yield("/interact")
    else
...
--            yield("/echo Umbral weather "..NextNode.umbralWeatherName.." detected")
    ...
    if NextNode.isUmbralNode and not NextNode.isFishingNode and
            ((NextNode.class == "採掘師" and GetClassJobId() ~= 16) or
                    (NextNode.class == "園芸師" and GetClassJobId() ~= 17))
    then
...
function Gather()
    ...
    if (NextNode.isUmbralNode and not NextNode.isFishingNode) or visibleNode == "GPmax 858以上 →採集回数／耐久＋5" then
    ...
    if (GetGp() >= (GetMaxGp() - 30)) and (GetLevel() >= 68) and visibleNode ~= "GPmax 858以上 →採集回数／耐久＋5" then
