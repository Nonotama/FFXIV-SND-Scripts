...
ZonesToFarmTable =
{
    ...
    -- EW 
    { zoneName="ラヴィリンソス",       zoneId=956, },
    { zoneName="サベネア島",           zoneId=957, },
    { zoneName="ガレマルド",           zoneId=958, },
    { zoneName="嘆きの海",             zoneId=959, },
    { zoneName="ウルティマ・トゥーレ", zoneId=960, },
    { zoneName="エルピス",             zoneId=961, },
    -- ShB
    { zoneName="レイクランド",         zoneId=813, },
    { zoneName="コルシア島",           zoneId=814, },
    { zoneName="アム・アレーン",       zoneId=815, },
    { zoneName="イル・メグ",           zoneId=816, },
    { zoneName="ラケティカ大森林",     zoneId=817, },
    { zoneName="テンペスト",           zoneId=818, },
}
